    ...
    return (
        <NavbarBs sticky='top' className='bg-white shadow-sm mb-3'>
            <Container>
                ...
                {cartQuantity > 0 && (<div className='rounded-circle bg-danger d-flex justify-content-center align-items-center' style={{ color: 'white', width: '1.5rem', height: '1.5rem', position: 'absolute', bottom: 0, right: 0, transform: 'translate(25%, 25%)' }}>{cartQuantity}</div>)}
                </Button>
            </Container>
        </NavbarBs>
    )
